all:test_addr test_sb test_mba test_fs
...
test_fs: small_oc_fs_test.cc ${_sb_area} ${_blk_addr} ${_mba} ${_ext} ${_fn} ${_fm}
	g++ -o test_fs -g \
        small_oc_fs_test.cc ${_sb_area} ${_blk_addr} ${_mba} ${_ext} ${_fn} ${_fm} \
        -std=c++0x -llightnvm
